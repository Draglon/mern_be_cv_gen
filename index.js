...
app.put('/personal_info/:id', checkAuth, personalInfoValidations.personalInfoValidation, handleValidationErrors, PersonalInfoController.update);
// Personal hobbies
...
app.put('/personal_hobbies/:id', checkAuth, personalHobbiesValidations.personalHobbiesValidation, handleValidationErrors, PersonalHobbiesController.update);
// Personal languages
...
app.put('/personal_languages/:id', checkAuth, personalLanguagesValidations.personalLanguagesValidation, handleValidationErrors, PersonalLanguagesController.update);
// Personal experience
...
app.put('/personal_experience/:id', checkAuth, personalExperienceValidations.personalExperienceValidation, handleValidationErrors, PersonalExperienceController.update);
// Personal education
...
app.put('/personal_education/:id', checkAuth, personalEducationValidations.personalEducationValidation, handleValidationErrors, PersonalEducationController.update);
// Personal courses
...
app.put('/personal_courses/:id', checkAuth, personalCoursesValidations.personalCoursesValidation, handleValidationErrors, PersonalCoursesController.update);
// Personal skills
...
app.put('/personal_skills/:id', checkAuth, personalSkillsValidations.personalSkillsValidation, handleValidationErrors, PersonalSkillsController.update);
// Personal tools
...
app.put('/personal_tools/:id', checkAuth, personalToolsValidations.personalToolsValidation, handleValidationErrors, PersonalToolsController.update);
